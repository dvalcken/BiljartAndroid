...
import com.example.biljart.fake.FakePlayerApiService
import com.example.biljart.network.asDomainObjects
import junit.framework.TestCase.assertEquals
import kotlinx.coroutines.test.runTest
import org.junit.Test

class ApiPlayerRepositoryTest { // Lesson 8  47' until end
    ...
    fun apiRankingRepository_getRanking_verifyRanksList() = runTest {
        ...
        val repository = ApiRankingRepository(FakePlayerApiService())
